...
%Define the path to the soon-to-be-reconstructed-DATA directory
%from where other inputs asked will start from this directory
[dataPath] = convertCharsToStrings(uigetdir('/','Select the directory containing the CS scan, inside the Bruker Raw Data...'));
